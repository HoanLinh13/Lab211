...
//
//
//                // Kiểm tra có cần đưa đón không
//                do {
//                    System.out.print("Need airport pick up? (Y/N): ");
//                    needPickUp = validateInput(scanner.nextLine().trim(), "YN");
//                } while (needPickUp == null);
//
//                if (needPickUp.equals("Y")) {
//                    // Nhập thông tin chuyến bay
//                    do {
//                        System.out.print("Flight: ");
//                        flight = validateInput(scanner.nextLine().trim(), "FLIGHT");
//                    } while (flight == null);
//
//                    do {
//                        System.out.print("Seat: ");
//                        seat = validateInput(scanner.nextLine().trim(), "SEAT");
//                    } while (seat == null);
//
//                    do {
//                        System.out.print("TimePickUp (dd/MM/yyyy hh:mmAM/PM): ");
//                        timePickup = validateInput(scanner.nextLine().trim(), "TIME");
//                    } while (timePickup == null);
//
//                    // Tạo đối tượng FlightInformation và lưu vào danh sách
//                    FlightInformation fi = new FlightInformation();
//                    fi.flightInformation(id, name, phone, roomNumber, bookingDate, flight, seat, timePickup);
//                    mr.createReservation(fi);
//                } else {
//                    // Tạo đối tượng Reservation và lưu vào danh sách
//                    Reservation re = new Reservation();
//                    re.reservation(id, name, phone, roomNumber, bookingDate);
//                    mr.createReservation(re);
//                }
...
//
//            case 2:
//                // Thêm code in danh sách đặt chỗ nếu cần
//                break;
//
//            case 3:
//                return;
